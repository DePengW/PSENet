...
def main(args):
    ...
    #points dataloader
    data_loader = CTW1500LoaderWdp(is_transform=True, img_size=args.img_size, kernel_num=kernel_num, min_scale=min_scale)
    ...
    logger.close()
    # time2 = time.time()
    # print("Speed per batch_size: {} /s".format( (end_time() - start_time) / args.n_epoch) )
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_epoch', nargs='?', type=int, default=601, 
                        help='# of the epochs')
